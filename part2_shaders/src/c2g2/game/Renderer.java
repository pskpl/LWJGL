...
public class Renderer {
    ...
    public ShaderProgram createSmoothShader() throws Exception {
    	ShaderProgram shaderProgram = new ShaderProgram();

        shaderProgram.createVertexShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/smooth_vertex.vs"))));
        shaderProgram.createFragmentShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/smooth_fragment.fs"))));
        shaderProgram.link();
    ...
    */
    ...
    public void init(Window window) throws Exception {
        ...
        shaderProgramList.put("smooth", createSmoothShader());
    ...
    public void render(Window window, Camera camera, GameItem[] gameItems, Vector3f ambientLight,
        ...
        else if(currentShader.equals("smooth")) {
        	shaderProgram.setUniform("projectionMatrix", projectionMatrix);
